...
define("CORE_LAN8", "Error de preferencias del núcleo");
define("CORE_LAN9", "Núcleo no podía restaurar desde copia de seguridad automática. Detiene la ejecución.");
define("CORE_LAN10", "Galleta corrupta detectado - usuario desconectado.");
...
define("LAN_ENTER", "Ingresar");
define("LAN_ENTER_CODE", "Ingrese código");
...
define("LAN_DOWNLOAD_NO_PERMISSION", "Archivo no encontrado o no tienes permiso para descargar este archivo!");
...
define("LAN_DEVELOPERMODE_CHECK", "[b]El modo de desarrollo está actualmente habilitado. Utilice este modo sólo cuando desarrolle! [/b] [br]Por favor, desactive el modo de desarrollo cuando utilice su sitio web en producción en vivo. Cuando el modo de desarrollo está habilitado, la información sensible puede ser mostrada al público!");
