...
define("COMLAN_6", "Usted debe estar conectado para hacer comentarios sobre este sitio.-inicia sesión o si usted no está registrado haga clic en");
define("COMLAN_7", "Administrador del sitio principal");
define("COMLAN_8", "Comentario");
define("COMLAN_9", "Enviar comentario");
define("COMLAN_10", "Administrador");
define("COMLAN_11", "Era incapaz de escribir su comentario en la base de datos - por favor, vuelva a escribir dejando de lado los caracteres no estándares.");
define("COMLAN_12", "Usuario");
define("COMLAN_16", "Nombre de usuario:");
define("COMLAN_100", "Noticias");
define("COMLAN_101", "Encuesta");
define("COMLAN_102", "Respuesta para:");
define("COMLAN_103", "Artículo");
define("COMLAN_104", "Revisión");
define("COMLAN_105", "Contenido");
define("COMLAN_106", "Descargar");
define("COMLAN_145", "Registrado:");
define("COMLAN_194", "Huésped");
define("COMLAN_195", "Miembro registrado");
define("COMLAN_310", "No se puede aceptar puesto username es registrado - si es su nombre de usuario por favor ingresa al post.");
