...
define("TPVLAN_96", "Establecer URLs/script-paths que deberían utilizar automáticamente este diseño. Uno por línea.");
define("TPVLAN_97", "Este tema requiere una versión más reciente de e107.");
define("TPVLANHELP_01", "El administrador de temas le permite establecer el tema público de su sitio y el tema de sus áreas de administración.");
define("TPVLANHELP_02", "Mira los consejos de herramientas (cuando estén disponibles) para más detalles.");
define("TPVLANHELP_03", "Por defecto, el filtro de visibilidad cambiará el diseño del tema basado en una coincidencia parcial de la URL.");
define("TPVLANHELP_04", "Termina las líneas con una [b]![/b] para que coincidan exactamente con el final de la URL.");
define("TPVLANHELP_05", "Termina las líneas con un [b]$[/b] para que coincidan exactamente con el final del camino del guión.");
define("TPVLANHELP_06", "Línea de inicio con una [b]:[/b] para que coincida parcial o totalmente con la constante e_ROUTE.");
